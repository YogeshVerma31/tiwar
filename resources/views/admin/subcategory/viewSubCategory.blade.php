                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">View Subject</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>  @if($category->status=='0')
                                                    <a href="" class="btn-sm btn btn-danger waves-effect waves-light">inactive</a> 
                                                    @else
                                                    <a href="" class="btn-sm btn btn-success waves-effect waves-light">active</a>
                                                    @endif
